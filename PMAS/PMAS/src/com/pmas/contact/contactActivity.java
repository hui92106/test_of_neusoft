...
public class contactActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		context = contactActivity.this;// 获取上下文对象
		...
		imageView1.setBackgroundResource(R.drawable.group2);
		imageView2.setBackgroundResource(R.drawable.people1);
	...
	public void initPager() {
		...
		Intent intent1 = new Intent(context, contactGroupActivity.class);
		ay.add(getView("contactGroupActivity", intent1));

		Intent intent2 = new Intent(context, contactPeopleActivity.class);
		ay.add(getView("contactPeopleActivity", intent2));
	...
	private class PageChangeListenerImp implements OnPageChangeListener {
		...
		public void onPageSelected(int arg0) {
			...
			imageView1.setBackgroundResource(R.drawable.group1);
			imageView2.setBackgroundResource(R.drawable.people2);
