...
public class noteTypeUpdateActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_note_type_update);
		...
		but1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Toast.makeText(noteTypeUpdateActivity.this, "修改成功", 1).show();
				noteTypeUpdateActivity.this.finish();
			}
		...
		but2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				new AlertDialog.Builder(noteTypeUpdateActivity.this)
						.setTitle("警告")
						.setMessage("是否删除")
						.setNegativeButton("是",
	...
	public void findById(String id) {
		mydbhelper mdb = new mydbhelper(noteTypeUpdateActivity.this);
		SQLiteDatabase sdb = mdb.getReadableDatabase();
		Cursor cur = sdb.query(mydbhelper.TABLE_NAME_NOTE_TYPE, new String[] {
				"_id", "ty_name", "ty_desc" }, "_id=?", new String[] { id },
				null, null, null);
	...
	public void updateGroup(String uup_tyname, String uup_tydesc, String sid) {
		...
		sdb.update(mydbhelper.TABLE_NAME_NOTE_TYPE, cv, "_id=?",
				new String[] { sid });
	}
	...
	public void delGroup(String sid) {
		mydbhelper mdb = new mydbhelper(noteTypeUpdateActivity.this);
		SQLiteDatabase sdb = mdb.getReadableDatabase();
		sdb.delete(mydbhelper.TABLE_NAME_NOTE_TYPE, "_id=?",
				new String[] { sid });
		finish();
	}
