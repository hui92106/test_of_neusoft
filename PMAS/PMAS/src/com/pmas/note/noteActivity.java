...
public class noteActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		context = noteActivity.this;// 获取上下文对象
		...
		imageView2.setBackgroundResource(R.drawable.daylife1);
	...
	public void initPager() {
		...
		Intent intent1 = new Intent(context, noteTypeActivity.class);
		ay.add(getView("noteTypeActivity", intent1));

		Intent intent2 = new Intent(context, noteMessageActivity.class);
		ay.add(getView("noteMessageActivity", intent2));
	...
	private class PageChangeListenerImp implements OnPageChangeListener {
		...
		public void onPageSelected(int arg0) {
			...
			imageView2.setBackgroundResource(R.drawable.daylife2);
